...
#         user_input : str = input("Vui lòng nhập số SAP nếu nhiều số SAP hãy cách nhau bằng dấu /:"+'   ')
#         if user_input !="" and isinstance(user_input,str) and user_input != 'close':
#                 try:
#                         user_sap = [user_sap.strip() for user_sap in user_input.split('/')]
#                         for sap in user_sap:
#                                 file : str = (f"C:\\Users\\nguye\\Documents\\WORKSPACE\\PYTHON\\Py\\GR Verification {sap}.xlsx")
